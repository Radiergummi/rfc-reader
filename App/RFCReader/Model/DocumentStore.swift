...
actor DocumentStore {
    ...
    func cachedIndex() throws -> (index: RFCIndex, updatedAt: Date)? {
        ...
        if FileManager.default.fileExists(atPath: indexURL.path) {
            url = indexURL
            updatedAt = (try? url.resourceValues(forKeys: [.contentModificationDateKey]).contentModificationDate) ?? .distantPast
    ...
    func document(_ id: DocumentID, formats: [FileFormat], client: RFCEditorClient) async throws -> RFCDocument {
