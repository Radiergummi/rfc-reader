...
To update, copy both files and `LICENSE` from a newer xml2rfc commit, record the commit here, and run the control and a full `make corpus-convert` before and after.
